...
if __name__ == '__main__':
    ...
    test_templates = [
        ...
        {% endif %}
        """,
        """{% if in_context %}{% if in_context == "Workings" %}Working{% else %} {% if in_context %}hello {{in_context}}{% endif %}{% endif %}{% endif %}""",
        """{% if in_context %}{% else %} {% if in_context %}hello{% endif %}{% endif %}""",
        """{% if in_context %}sdfg{% else %} hello my name is {{in_context}}{% endif %}"""
    ]
